        ...
        procesar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (estadoCivilValor.length() > 0 &&
                    ...
                    //Creamos un objeto de persona en donde se cargaran todos los datos
                    Persona persona=new Persona();
                    persona.setId(LISTA.size()+1);
                    persona.setNombre(nombreValor);
                    persona.setGenero(genero);
                    persona.setEstadoCivil(estadoCivilValor);
