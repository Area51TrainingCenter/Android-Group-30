...
public class RELCalculatorSoap
{
    ...
    public RELCalculatorSoap(){}

    public RELCalculatorSoap(String url)
    {
        this.url = url;
    }

    public RELCalculatorSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        RELExtendedSoapSerializationEnvelope envelope= new RELExtendedSoapSerializationEnvelope(RELExtendedSoapSerializationEnvelope.VER11);
        return envelope;
    }
